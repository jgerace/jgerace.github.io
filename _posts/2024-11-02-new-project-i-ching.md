...
This kind of thing exists online{% include sn.html id="ichingonline" note="A few: [ichingonline.net](https://www.ichingonline.net), [Eclectic Energies](https://www.eclecticenergies.com/iching/virtualcoins), [AI Ching](https://aiching.app/consult-the-i-ching/)" %}, but the sites I've seen don't have a meditative quality to them at all. You click a bunch of buttons and get an immediate result. It's too fast. I wanted to make something that was easy to use, but gives more opportunity for reflection.
