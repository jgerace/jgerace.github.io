---
title: "My Thoughts on the Framework Laptop"
...
The four expansion ports are [not all created equal](https://knowledgebase.frame.work/expansion-card-functionality-on-framework-laptop-13-amd-ryzen-ai-300-series-Hy5SfMRs1l). They have different capabilities, so you have to choose where you install each card depending on what cards you buy and what you want to do with them. According to the graphic on that link the left front port is one of the ones that should be perfect for USB-A!
